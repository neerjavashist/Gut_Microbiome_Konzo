...
do bmtagger.sh -C /data/Neerja/scripts/Konzo3_bmtagger.conf -b /data/Neerja/hg38/Homo_sapiens_assembly38.bitmask -x /data/Neerja/hg38/Homo_sapiens_assembly38.srprism -T /data/Neerja/temp -q 1 -1 $f/*R1*.fastq -2 $f/*R2*.fastq -X -o /data/Neerja/Konzo3_output/bmtagger/$(basename $f)
done
